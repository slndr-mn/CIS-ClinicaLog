...
<script>
    ...
    departmentSelect.innerHTML = '<option selected disabled>Select department</option>'; // Clear existing options

    if (departmentOptions[selectedcollege]) {
        departmentOptions[selectedcollege].forEach(department => {
